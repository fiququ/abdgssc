    ...
    loadCollege() {
        ...
        loader.load(
            ...
            function (gltf) {
                ...
                // Traverse and manipulate college model if needed
                ...
                // Load the Tango model
                const tangoLoader = new GLTFLoader().setPath(self.assetsPath);
                tangoLoader.load(
                    'tango-fbx-export-e3785c1fbf2f4842b25972197701c9fe.glb',
                    function (tangoGltf) {
                        const tango = tangoGltf.scene;
                        tango.position.set(10, 0, 15); // Set the position of the Tango model
                        self.scene.add(tango);
                    },
                    undefined,
                    function (error) {
                        console.error('Error loading Tango model', error);
                    }
                );
